...
const std::vector<BindingDefault>& VimMotionsSettings::defaultBindings()
{
    static const std::vector<BindingDefault> bindings = {
        ...
        {"VimMotions/Bindings/Normal/'", "beginJumpToMark"},
        {"VimMotions/Bindings/Normal/`", "beginJumpToMark"},
        ...
        {"VimMotions/Bindings/Normal/<Esc>", "clearPending"},
        ...
        {"VimMotions/Bindings/Visual/<Esc>", "leaveVisualMode"},
        ...
        {"VimMotions/Bindings/Visual/'", "beginJumpToMark"},
        {"VimMotions/Bindings/Visual/`", "beginJumpToMark"},
        ...
        // -- Insert mode --
        {"VimMotions/Bindings/Insert/<Esc>", "leaveInsertMode"},
    };
    return bindings;
}
...
VimMotionsSettings::VimMotionsSettings(SettingsManager* settingsManager)
{
    ...
    settingsManager->createSetting<EnableSettingsUi>(false, u"VimMotions/EnableSettingsUi"_s);
