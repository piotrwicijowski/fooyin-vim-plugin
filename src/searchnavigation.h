...
[[nodiscard]] inline int firstSearchMatchIndex(const std::vector<int>& matches, int startRow,
                                               bool wrapScan)
{
...
[[nodiscard]] inline int nextSearchMatchIndexForRow(const std::vector<int>& matches, int currentRow,
                                                    bool wrapScan)
{
    for (int i = 0; i < static_cast<int>(matches.size()); ++i) {
...
[[nodiscard]] inline int prevSearchMatchIndexForRow(const std::vector<int>& matches, int currentRow,
                                                    bool wrapScan)
{
